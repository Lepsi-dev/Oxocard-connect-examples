...
<a href="https://github.com/Lepsi-dev/Oxocard-connect-examples/tree/main/Gyroskop>"Simple example</a> how to read the data from GY-521 via i2c protocol and how to handle the angle values
